...
## Blogs:
1. Confusing LLMs with Adversarial Inputs. [Read](https://medium.com/p/4a2269f5e20b/edit) inspired by a recent kaggle competition I participated in named [LLMs: You Can't Please Them All](https://www.kaggle.com/competitions/llms-you-cant-please-them-all). **`Under Construction`**
